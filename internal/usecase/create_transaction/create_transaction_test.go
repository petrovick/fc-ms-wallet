...
func TestCreateTransactionUseCase_Execute(t *testing.T) {
	...
	client2, _ := entity.NewClient("client2", "j2@j")
	...
	mockAccount.AssertExpectations(t)     // Verifica se o mock funcionou
	mockTransaction.AssertExpectations(t) // Verifica se o mock funcionou
